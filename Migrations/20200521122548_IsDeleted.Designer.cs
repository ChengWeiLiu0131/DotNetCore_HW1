...
namespace hw1.Migrations
{
    ...
    [Migration("20200521122548_IsDeleted")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hw1.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("hw1.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hw1.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("hw1.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("hw1.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hw1.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("hw1.Models.Course", b =>
                {
                    b.HasOne("hw1.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("hw1.Models.CourseInstructor", b =>
                {
                    b.HasOne("hw1.Models.Course", "Course")
                    ...
                    b.HasOne("hw1.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("hw1.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("hw1.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("hw1.Models.OfficeAssignment", b =>
                {
                    b.HasOne("hw1.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("hw1.Models.OfficeAssignment", "InstructorId")
